...
data class ShotHistoryItem(
    ...
    val comparisonTitleLabel: String = ShotHistoryMapper.UNASSIGNED_BEAN_LABEL,
    val comparisonMetadataLabel: String? = null,
    val comparisonMetricsLabel: String = ShotHistoryMapper.UNKNOWN_COMPARISON_METRICS_LABEL,
